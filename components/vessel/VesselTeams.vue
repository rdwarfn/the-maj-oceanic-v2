<template>
  <v-container tag="section" class="px-0 px-sm-6 px-md-0 the-teams">
    ...
    <swiper ref="swiper" class="swiper" :options="swiperOption">
      <swiper-slide v-for="item in data.data" :key="item.id">
        <div class="text-center swiper__item">
          ...
          <div v-if="item.name" class="swiper__item--heading font-weight-bold hidden-xs-only" style="font-family: Domine">
            {{ item.name }}
          </div>
    ...
    <div class="mx-auto text-center hidden-sm-and-up">
      <div v-if="dataActive.heading" class="swiper__item--heading font-weight-bold">
        {{ dataActive.name }}
      </div>
      <div v-if="dataActive.title" class="swiper__item--text">
        {{ dataActive.title }}
      </div>
    </div>

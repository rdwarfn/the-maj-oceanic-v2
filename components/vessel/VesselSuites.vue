<template>
  <v-container
    tag="section"
    class="suites-and-staterooms px-0 text-center"
  >
    <v-row
      no-gutters
      class="text-center"
    >
      ...
      >
        ...
        <swiper
          ref="swiper"
          class="swiper container py-0 px-0 px-sm-6 px-md-0"
        ...
        >
          ...
          >
            ...
            </swiper-slide><swiper-slide :key="index + 1">
              <div class="text-center swiper__item">
                <v-skeleton-loader
                  v-if="!item.commodore.gallery"
                  class="swiper__item--img"
                  type="image"
                />
                <v-img
            ...
            </swiper-slide><swiper-slide :key="index + 2">
              <div class="text-center swiper__item">
                <v-skeleton-loader
                  v-if="!item.deluxe.gallery"
                  class="swiper__item--img"
                  type="image"
                />
                <v-img

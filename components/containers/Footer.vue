  ...
  >
    <v-container class="px-6 px-md-0">
        ...
        >
          ...
          <div class="mb-6">
            ...
            >
              <v-col cols="4">
                <v-img
                  :src="require('~/assets/images/svg/the_maj_experience.svg?data')"
                  :lazy-src="require('~/assets/images/svg/the_maj_experience.svg?data')"
                  min-width="75"
                  max-width="76"
                  class="mr-14"
                />
              ...
              <v-col cols="5">
                <v-img
                  :src="require('~/assets/images/svg/the_maj_group.svg?data')"
                  :lazy-src="require('~/assets/images/svg/the_maj_group.svg?data')"
                  min-width="75"
                  max-width="91.91"
                />
              </v-col>
            ...
            <v-row no-gutters>
              ...
              >
                ...
                <v-btn
                  ...
                  small
                  target="_blank"
                  href="https://yachtsourcing.com/"
                >
                  <v-img
                    class="ml-n1"
                    :src="require('~/assets/images/svg/tmo_yacht_sourching.svg?data')"
                    :lazy-src="require('~/assets/images/svg/tmo_yacht_sourching.svg?data')"
                    max-width="45"
                  />
                </v-btn>
              </v-col>
              ...
              >
                ...
                <v-btn
                  ...
                  small
                  target="blank"
                  href="https://global.sunbrella.com/"
                >
                  <v-img
                    class="ml-n1"
                    :src="require('~/assets/images/svg/tmo_sanbrella.svg?data')"
                    :lazy-src="require('~/assets/images/svg/tmo_sanbrella.svg?data')"
                    max-width="66"
                  />
                </v-btn>
              </v-col>
      ...
      <v-row
        no-gutters
        align="start"
        class="text-sm-center mt-6 mt-sm-1 mt-lg-0"
      >
        <v-col
          tag="span"
          class="px-0"

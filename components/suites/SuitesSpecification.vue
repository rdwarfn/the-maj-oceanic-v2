<template>
  <v-container class="suites-and-staterooms px-0 px-sm-6 px-md-0" :class="{reversed: reverse}">
    ...
    <div class="data--heading px-6 px-md-0 font-weight-bold text-center hidden-sm-and-up" v-html="dataActive.heading" />
    ...
    <v-card class="data--card" :class="{reversed: reverse}" flat tile>
      <div class="hidden-xs-only">
        <slot name="icon" />
        <v-card-subtitle class="pa-0 text-h6 data--caption">
          {{ dataActive.caption }}
        </v-card-subtitle>
        <v-card-title class="pa-0 ml-lg-0 font-weight-bold data--heading" v-html="dataActive.heading" />
        <div class="data--sqm">
          <em class="data--sqm-em">{{ dataActive.sqm }} sqm</em>
        </div>
      </div>
